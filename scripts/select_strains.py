...
def flu_subsampling(metadata, viruses_per_month, time_interval, titer_fname=None, priority_region=None, priority_region_fraction=0.5):
    ...
    def threshold_fn(x):
        ...
        if priority_region is None:
            ...
            # of the total viruses per month have been selected. The remaining
            # regions divided up the remaining viruses per month.
            strains_selected = int(np.ceil(priority_region_fraction * viruses_per_month))
